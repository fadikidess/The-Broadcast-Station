...
<div id="mySidenav" class="sidenav">
  ...
  <a href="/feedcomp.php"> View Competitions</a>
  <a href="/createcomp.php"> Create Competition</a>
...
foreach($fileList as $filename){
   ...
   echo "<hr>","<a href='/compreed.php?id=".$filename."'<h3>". fgets($myfile)."<div align='center'>".substr($filename, 17,-8)."</div>";
  if(substr($filename,-3,3) != "mp4"){
   echo "<br><audio alt=''src='".$filename."' id='".$filename."'controls></audio><img src='".$filename."' width='250px'/><video src='".$filename."' width='250px'/>";
       ...
       echo "<br><video src='".$filename."' id='".$filename."'width='250px'/>"."<div align='center'>".substr($filename, 17,-8)."</div>";
